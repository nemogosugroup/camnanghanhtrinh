...
class CategoryMedalController extends Controller
{
    /**
    ...
    public function __construct(BaseCategoryRepositoryInterface $cateRepo, Message $message, Helpers $helper, CategoryMedal $model)
    {

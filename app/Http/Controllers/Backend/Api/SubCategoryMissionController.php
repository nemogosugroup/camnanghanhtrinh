...
class SubCategoryMissionController extends Controller
{
    /**
    ...
    public function __construct(BasePostRepositoryInterface $cateRepo, Message $message, Helpers $helper, SubCategoryMission $model, CategoryMission $modalCate)
    {
        $this->msg = $message;
        $this->helper = $helper;

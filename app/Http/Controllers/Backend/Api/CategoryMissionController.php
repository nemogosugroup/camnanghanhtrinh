...
//use App\Repositories\Interfaces\Backend\CategoriesMissionRepositoryInterface;
use App\Repositories\Backend\Interfaces\BaseCategoryRepositoryInterface;
use App\Helpers\Message;
use App\Helpers\Helpers;
use App\Models\CategoryMission;

class CategoryMissionController extends Controller
{
    /**
    ...
    public function __construct(BaseCategoryRepositoryInterface $cateRepo, Message $message, Helpers $helper, CategoryMission $model)
    {
        $this->msg = $message;
        $this->helper = $helper;
